...
import com.cyster.mvp.chat.ErrorResponse;

/** Implementation of {@link ErrorResponse} used by the exception handler. */

@Schema(name = "RestErrorResponse", description = "Error body returned when a RestException is thrown")
public record RestErrorResponse<CODE extends Enum<CODE>>(
